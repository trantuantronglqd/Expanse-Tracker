...
builder.Services.AddDbContext<Expanse_TrackerDbContext>(options =>
options.UseSqlServer(builder.Configuration.GetConnectionString("Expanse_TrackerDbContextConnection")));
